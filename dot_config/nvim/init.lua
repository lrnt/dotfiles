...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sf', builtin.find_files, { desc = '[S]earch [F]ileles' })
  ...
  { -- Highlight, edit, and navigate code
    ...
    config = function()
      ...
      local function attach(buf, lang)
        if not vim.api.nvim_buf_is_valid(buf) or vim.treesitter.language.get_lang(vim.bo[buf].filetype) ~= lang then
          return false
        end
      ...
      vim.api.nvim_create_autocmd('FileType', {
        ...
        callback = function(event)
          ...
          if not lang or attach(event.buf, lang) or not vim.list_contains(treesitter.get_available(), lang) then
            return
          end
